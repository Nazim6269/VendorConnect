...
const ZeroHassle = () => {
    return (
        <Container className='py-10 lg:py-30 '>
            <div className='flex flex-col lg:flex-row justify-between gap-8 lg:gap-15 items-center bg-white dark:bg-bgColorOne rounded-2xl border border-borderColor '>
